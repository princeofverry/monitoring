      ...
      <div className="relative h-screen w-screen overflow-hidden">
        ...
        <div className="relative flex flex-row items-center justify-evenly">
          <div className='flex flex-col items-center font-semibold'>
            <img src="src/assets/undip.png" alt="logo-undip" className='md:w-20 md:h-20 w-16' />
            {/* <p className='md:text-base text-xs'>Universitas Diponegoro</p> */}
          </div>
          <h1 className='text-center md:text-3xl text-xl font-bold text-white'>Monitoring</h1>
          <div className='flex flex-col items-center font-semibold'>
            <img src="src/assets/aterkia.png" alt="logo-ater" className='md:w-28 md:h-28 w-16' />
